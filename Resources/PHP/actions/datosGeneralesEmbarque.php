...
//$aduana = 240;
      ...
      $datosEmbarque .= "
        ...
        <tr class='row pt-4'>
          <td class='pt-0 pb-0 col-md-2 text-right b'><b>Aduana:</b></td>
          <td class='p-0 col-md-2 text-left'>$id_aduanaReferencia</td>
          <td class='pt-0 pb-0 col-md-2 text-right b'><b>Procedencia o destino:</b></td>
          <td class='p-0 col-md-2 text-left'>$row_buscaRef[procedencia]</td>
          <td class='pt-0 pb-0 col-md-2 text-right b'><b>Tipo de operación:</b></td>
      	  <td class='p-0 col-md-2 text-left'>$row_buscaRef[s_tipo]</td>
        </tr>

        <tr class='row pt-3'>
          <td class='pt-0 pb-0 col-md-2 text-right b'><b>Tipo:</b></td>
          <td class='p-0 col-md-2 text-left'>$txt_tipo</td>
          <td class='pt-0 pb-0 col-md-2 text-right b pl-0'><b>Fecha arribo o salida:</b></td>
          <td class='p-0 col-md-2 text-left'>$fecha_entrada</td>
          <td class='pt-0 pb-0 col-md-2 text-right b'><b>Talones, Guia o B/Ls:</b></td>
        ...
        <tr class='row align-items-center' style='padding-top: .7rem!important;'>
          <td class='pt-0 pb-0 col-md-2 text-right b'><b>Nuestra referencia:</b></td>
          ...
          <td class='pt-0 pb-0 col-md-2 text-right b'><b>Peso en Kg:</b></td>
          <td class='p-0 col-md-2 text-left'>$peso</td>
          <td class='pt-0 pb-0 col-md-2 text-right b'><b>Valor Aduana M.N.:</b></td>
      	  <td class='p-0 col-md-2 text-left'>$valor</td>
        </tr>

        <tr class='row borderojo pb-4 pt-3'>
          <td class='pt-0 pb-0 col-md-2 text-right b'><b>Su Referencia:</b></td>
          <td class='p-0 col-md-2 text-left'>$refCli</td>
          <td class='pt-0 pb-0 col-md-2 text-right b'><b>No. Pedimento:</b></td>
          <td class='p-0 col-md-2 text-left'>$row_buscaRef[s_pedimento]</td>
          <td class='pt-0 pb-0 col-md-2 text-right b'><b>Tipo de cambio:</b></td>
      	  <td class='p-0 col-md-2 text-left'>$tipoCambio</td>
        </tr>

        <tr class='row mt-4 align-items-center'>
          <td class='pt-0 pb-0 col-md-2 text-right b'><b>Días en almacen:</b></td>
          ...
          <td class='pt-0 pb-0 col-md-3 text-right b'><b>Shipper:</b></td>
          <td class='p-0 col-md-1'>
            <input class='text-left bt inputId p-0' type='text' id='DGE_shipper' value='$shipper' readonly>
          </td>

          <td class='pt-0 pb-0 col-md-3 text-right b'><b>Núm. de Facturas:</b></td>
      	  <td class='p-0 col-md-2 text-left'><textarea class='border-0 form-control bt inputId p-0 font12' readonly>$facturas</textarea></td>
        </tr>

         <tr class='row mt-2 align-items-center'>
           <td class='pt-0 pb-0 col-md-2 text-right b'><b>Flete: $status_flete</b></td>
           <td class='p-0 col-md-1'><input class='text-left bt inputId p-0' type='text' id='DGE_flete' value='$flete' readonly></td>

           <td class='pt-0 pb-0 col-md-3 text-right b'><b>InBond:</b></td>
           <td class='p-0 col-md-1'><input class='text-left bt inputId p-0' type='text' id='DGE_inbond' value='$inbond' readonly></td>

           <td class='pt-0 pb-0 col-md-3 text-right b'><b>Trailer de Salida:</b></td>
           <td class='p-0 col-md-1 text-left'>$row_buscaRef[s_trailerOut]</td>
        </tr>


        <tr class='row pt-2 align-items-center'>
          <td class='pt-0 pb-0 col-md-2 text-right b'><b>Cobrar:</b></td>
          <td class='p-0 col-md-1 text-left'>$fleteOption</td>

          <td class='pt-0 pb-0 col-md-3 text-right b'><b>Reexpedición:</b></td>
          <td class='p-0 col-md-1 text-left'>$row_buscaRef[reexpedicion]</td>

          <td class='pt-0 pb-0 col-md-3 text-right b'><b>Entradas:</b></td>
          <td class='p-0 col-md-1'><input class='text-left bt inputId p-0' type='text' id='DGE_entradas' value='$entradas' readonly></td>
        </tr>

        <tr class='row pt-2 align-items-center'>
          <td class='pt-0 pb-0 col-md-2 text-right b'><b>Consolidado:</b></td>
          <td class='p-0 col-md-1'>
        ...
        <tr class='row mt-5 align-items-center'>
          <td class='pt-0 pb-0 col-md-2 text-right b'><b>Estatus:</b></td>
