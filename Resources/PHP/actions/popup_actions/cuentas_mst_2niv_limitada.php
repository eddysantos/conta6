...
$query = "SELECT * FROM conta_cs_cuentas_mst WHERE ((pk_id_cuenta LIKE ? and s_cta_nivel = '2')  OR (s_cta_desc LIKE ? and s_cta_nivel = '2')) and
               pk_id_cuenta not like '%-00000%' and s_cta_status = 1 and
						   pk_id_cuenta not between '0530-00001' and '0530-00010' and
						   pk_id_cuenta <> '0530-00012' and
						   pk_id_cuenta <> '0530-00013' and
						   pk_id_cuenta <> '0530-00018' and
					     pk_id_cuenta <> '0530-00019' and
						   pk_id_cuenta <> '0530-00021' and
						   pk_id_cuenta <> '0530-00070' and
