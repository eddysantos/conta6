...
$query_consultaFactura = "SELECT * from conta_t_facturas_captura where pk_id_cuenta_captura in
														(select fk_id_cuenta_captura from conta_t_facturas_cfdi where pk_id_factura = ?) ";
...
$stmt_consultaFactura->bind_param('s',$id_factura);
if (!($stmt_consultaFactura)) {
	$system_callback['code'] = "500";
