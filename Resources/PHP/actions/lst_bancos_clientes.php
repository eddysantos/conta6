...
FROM conta_cs_bancos_clientes A
INNER JOIN  conta_cs_sat_bancos B ON  A.fk_id_banco = B.pk_id_banco
WHERE  A.fk_id_cliente = '$id_cliente' ORDER BY B.s_nombre";
