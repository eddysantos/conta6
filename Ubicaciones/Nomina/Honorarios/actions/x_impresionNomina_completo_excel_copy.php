...
<body>
	<table border="0" width="100%" cellspacing="1" style="font-family: Trebuchet MS;">
		...
		<tr>
			<td width="100%" colspan="10" bgcolor="#000000" align="center" style="color:#FFFFFF">Empleados Bajo el Régimen de Honorarios Asimilables a Salarios</td>
		</tr>
</table>
...
# falta mostrar  id_poliza,pol_cancela,id_factura,UUID

  $sql_consultaNomina=mysqli_query($db,"SELECT n_anio, n_semana, fk_id_empleado, s_nombre, s_apellidoM, s_apellidoP, pk_id_docNomina, fk_id_aduana, n_salarioDiarioIntegrado
                                        FROM conta_t_nom_captura
                                        WHERE fk_id_regimen = '$id_regimen' AND $consulta
                                        ORDER BY n_semana,NOMBRE");
  ...
  ?>
    ...
    <td align="center"><?php echo $pol_cancela; ?></td>
