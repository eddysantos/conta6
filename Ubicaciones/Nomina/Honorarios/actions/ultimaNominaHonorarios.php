...
#$first = strtotime('last Mondey -7 days');
$last = strtotime('next Friday -7 days');
$first = strtotime("$last -4 days");
...
$sql_SelectANIO = "SELECT MAX(n_anio) as anio FROM conta_t_nom_captura where fk_id_regimen = '09' and fk_id_aduana = ?";
...
$sql_SelectULTNOM = "SELECT max(n_semana) as id_nomina
                     ...
                     where fk_id_aduana = ? and fk_id_regimen = '09' and n_anio = ?
...
$sql_SelectFECHA = "SELECT d_fechaInicio,d_fechaFinal
                     FROM conta_t_nom_captura
                     where fk_id_aduana = ? and fk_id_regimen = '09' and n_anio = ? and n_semana = ?
                      and pk_id_docNomina in ( select fk_id_docNomina
                                               from conta_t_nom_cfdi
                                               where s_selloSATcancela is null )";
