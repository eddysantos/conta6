...
$stmt_UPDATE->bind_param('sssssssssssssssssssssssssssssss', $concepto,
                                                            $importeGravado,
                                                            $importeExento,
                                                            $anio,
                                                            $remanenteSalFav,
...
if (!($stmt_UPDATE->execute())) {
  $system_callback['code'] = "500";
  $system_callback['message'] = "Error during query execution UPDATE [$stmt_UPDATE->errno]: $stmt_UPDATE->error";
}
?>
