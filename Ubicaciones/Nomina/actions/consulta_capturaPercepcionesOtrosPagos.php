...
while ($row_capturaPercepcionesOP = $rslt_capturaPercepcionesOP->fetch_assoc()) {
  ...
  <tr class='row mt-4 m-0 trPERCEPOP elemento-percepop' id='$partidaPOP'>
    <td class='col-md-1 input-effect'>
      ...
      <input type='hidden' id='T_PERCEPOP_ordenRep' class='T_PERCEPOP_ORDENREP ordenRep' value='$ordenReportePOP' >
    </td>
    ...
    <td class='col-md-1 input-effect'>
      <input type='text' id='T_PERCEPOP_exento$partidaPOP' class='T_PERCEPOP_EXENTO exento efecto' value='$importeExentoPOP' onblur='validaIntDec(this);' onchange='sumaGeneralNomina()'>
    </td>
    <td class='col-md-1 input-effect'>
