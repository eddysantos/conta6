  ...
  <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
    <div class="modal-content bordenegro border-radius">
      <div class="modal-header border-0">
        <h3 class="modal-title mx-3 s_gris_100">Editar Datos de Empleado</h3>
      ...
      <div class="modal-body p-0">
        <ul class="nav nav-justified backpink" id="myTab" role="tablist">
          <li class="nav-item">
            <a class="nav-link active" id="dgen-tab" data-toggle="tab" href="#dgen" role="tab" aria-controls="dgen" aria-selected="true">Datos Generales</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="dlab-tab" data-toggle="tab" href="#dlab" role="tab" aria-controls="dlab" aria-selected="false">Datos Laborales</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="dsal-tab" data-toggle="tab" href="#dsal" role="tab" aria-controls="dsal" aria-selected="false">Distr. Salario</a>
          </li>

          <li class="nav-item suelysal-1">
            <a class="nav-link emp suel" id="dsuel-tab" data-toggle="tab" href="#dsuel" role="tab" aria-controls="dsuel" aria-selected="false">Sueldos y Salarios</a>
          </li>
          <li class="nav-item honorariosAsim-1">
            <a class="nav-link emp hon" id="hon-tab" data-toggle="tab" href="#hon" role="tab" aria-controls="hon" aria-selected="false">Honorarios Asimilados</a>
          </li>

        </ul>
        <div class="tab-content contorno text-center" id="myTabContent">
          <div class="tab-pane fade show active" id="dgen" role="tabpanel" aria-labelledby="dgen-tab">
          ...
          <div class="tab-pane fade" id="dlab" role="tabpanel" aria-labelledby="dlab-tab">
          ...
          <div class="tab-pane fade" id="dsal" role="tabpanel" aria-labelledby="dsal-tab">
          ...
          <div class="tab-pane fade" id="dsuel" role="tabpanel" aria-labelledby="dsuel-tab">
            <div id="sueldos" class="suelysal">
          ...
          <div class="tab-pane fade" id="hon" role="tabpanel" aria-labelledby="hon-tab">
            <div id="hon_has" class="contorno  honorariosAsim">
              <form class="form1">
                <table class="table">
                  <tbody>
    ...
    <div class="modal-content bordenegro">
      <div class="modal-header border-0 align-items-center">
        <div class='text-left ml-4' style='width:900px'>
          <h5>Editar Datos Permanentes</h5>
        </div>
        <a href="#" type="button" class="close mr-3" data-dismiss="modal" aria-label="Close"><img style='width:35px' src="/Resources/iconos/close.svg"></a>
      </div>
      <div class="modal-body p-0">
      ...
      <!--********************************Submenu*******************************-->
        ...
        <ul class="nav nav-justified backpink" id="myTab" role="tablist">
          <li class="nav-item pills">
            <a class="nav-link active" id="percp-tab" data-toggle="tab" href="#percp" role="tab" aria-controls="percp" aria-selected="true">Percepciones</a>
          </li>
          <li class="nav-item pills col">
            <a class="nav-link" id="perc-tab" data-toggle="tab" href="#perc" role="tab" aria-controls="perc" aria-selected="false">Deducciones</a>
          </li>
        </ul>

        <div class="tab-content contorno" id="myTabContent">
          <div class="tab-pane fade show active" id="percp" role="tabpanel" aria-labelledby="percp-tab">
