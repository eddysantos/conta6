...
while ($row = $rslt->fetch_assoc()) {
  ...
  $system_callback['data'] .='<tr class="row m-0 borderojo">
    <td class="col-md-1">
      <button type="button" class="btn btn-outline-secondary btn-sm addCorresp" name="button" db-id="'.$pk_id_corresp.'" data-target="#addCorresp" data-toggle="modal">Detalle</button>
    </td>
