<?php
#http://localhost:88/Ubicaciones/Contabilidad/Reportes/contabilidad/auxiliares_Excel.php?numreporte=1&Oficina=470&Fecha_Inicial=2020-01-01&Fecha_Final=2020-08-31&Cta_Inicial=0100-00001
...
if (  $oRst_permisos['s_contabilidad_todos'] == 1 || $rslt_permisosReportes->num_rows > 0) {
  ...
  if( $Oficina == 1 ){
    require $root . '/Ubicaciones/Contabilidad/Reportes/actions/saldosIniciales_cta.php';
    require $root . '/Ubicaciones/Contabilidad/Reportes/actions/consultaDetallePoliza.php';
  }else{
    require $root . '/Ubicaciones/Contabilidad/Reportes/actions/saldosIniciales_ctaOficina.php';
    require $root . '/Ubicaciones/Contabilidad/Reportes/actions/consultaDetallePoliza_oficina.php';
  }
