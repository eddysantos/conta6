<?php
#http://localhost:88/conta6/Ubicaciones/Contabilidad/notacredito/1-notacredito_elaborar.php?cuenta=185&id_cliente=CLT_7345
      ...
      <div id='contornoInfo' class='contorno' style='display:none'>
        ...
        <table class='table' id='eInfo'>
          <thead>
            ...
            <tr class='row backpink font14 justify-content-center'>
      ...
      <div id="detalleEmbarque" class="contorno" style="display:none">
        <table class="table form1">
          ...
          <tbody class="font14" id='tbodyDGE'>
            <tr class="row borderojo align-items-center">
      ...
      <div class="contorno" style="<?php echo $marginbottom ?>">
        <table class="table">
         ...
         <tr class="row justify-content-center">
           ...
           <td class="col-md-2">
             <input class="efecto h22" type="text" id="T_totalFactura" size="20" value="<?php echo $n_total_gral_importe;?>" readonly />
           </td>
         </tr>
       </table>
        ...
        <div class="row justify-content-center">
          <div class="col-md-3">
            <input class="efecto boton validarstring" type='button' value="GUARDAR" onclick="validarStringSAT(this);quitarNoUsar(this);" id="guardar-cta-NC" tabindex="<?php echo $tabindex = $tabindex+1; ?>">
          </div>
          <!-- <div id="mensaje"></div> -->
        </div>
      </div>
