<?php
#http://localhost:88/conta6/Ubicaciones/Contabilidad/notacredito/1-notacredito_modificar.php?cuenta=185&id_cliente=CLT_7345
...
if($referencia != "SN"){
    ...
    require $root . '/conta6/Ubicaciones/Contabilidad/Notacredito/actions/extraer_conceptosFacturados.php';
              ...
              <form class='form1' onsubmit="return false">
                ...
                <table class='table'>
                  ...
                  <tbody id="tbodyCargos">
                    <tr id="9" class="row m-0 align-items-center">
                      <td class='col-md-6 p-1 b font12 ls1'>Impuestos Afianzados o Subsidiados</td>
      ...
      <div class="contorno" style="<?php echo $marginbottom ?>">
        <table class="table">
          <tr class="row backpink justify-content-center">
            ...
            <td class="col-md-4">Factura Relacionada</td>
            <td class="col-md-2">Total</td>
          </tr>
            <tr class="row justify-content-center">
            <td class="col-md-2">
              <input class="efecto h22" type="text" id="T_idFactura" size="14" value="<?php echo $pk_id_factura;?>" readonly>
            </td>
            <td class="col-md-4">
            ...
            <td class="w-50">
              <table class="table">
                <tr class="row align-items-center">
                  <td class="col-md-3 text-left"> CUSTOMS DC </td>
                  <td class="col-md-3">
                ...
                <tr class="row sub2">
                  ...
                  <td class="col-md-3 p-0 align-self-center">Tipo Cambio (4 dec.)</td>
                </tr>

                <tr class="row">
                  <td class="col-md-3">
                    <input class="efecto h22" type="text" id="T_FormaPago" value="<?php echo $fk_id_formapago; ?>" size="20" readonly>
                  </td>
                  <td class="col-md-3">
                    <input class="efecto h22" type="text" id="T_CuentaPago" value="<?php echo $s_numCtaPago; ?>" size="20" readonly>
                  </td>
                  <td class="col-md-3">
                    <input class="efecto h22" type="text" id="T_Moneda" size="6" value="<?php echo $fk_id_moneda; ?>" readonly>
                  </td>
                  <td class="col-md-3">
                    <input type="text" id="T_monedaTipoCambio" class="efecto h22" value="<?php echo $n_tipoCambio; ?>" readonly size="18" onBlur="validaIntDec(this);" />
                  </td>
                </tr>
              </table>
            </td>
            <td class="w-50">
              <table class="table font14">
                <tbody>
                  ...
                  <tr class="row">
                    <td class="p-1 col-md-8">
                      <input class="h22 bt border-0 text-right efecto" type="text" id="Txt_Total_Anticipos" size="40" readonly value="<?php echo $s_txt_total_depositos; ?>">
                    </td>
                    ...
                    <td class="p-1 col-md-2">
                      <input class="h22 w-100 efecto" type="text" id="T_Total_Anticipos" size="20" value="<?php echo $n_total_depositos; ?>" readonly>
                    </td>
                  </tr>
        ...
        <div class="row justify-content-center">
          <div class="col-md-3">
            <input class="efecto boton validarstring" type='button' value="MODIFICAR" onclick="validarStringSAT(this);quitarNoUsar(this);" id="modificar-cta-NC" tabindex="<?php echo $tabindex = $tabindex+1; ?>">
          </div>
          <!-- <div id="mensaje"></div> -->
        </div>
      </div>
    ...
    <?php
      require $root . '/conta6/Ubicaciones/Contabilidad/Notacredito/actions/consultarCapturaCuenta_datosDepositos.php'; #$datosDepositos, $depositosAplicados
      require $root . '/conta6/Resources/PHP/actions/depositos_sinAplicar.php'; #$depositosSinAplicar
      require $root . '/conta6/Ubicaciones/Contabilidad/Notacredito/modales/depositos.php';
