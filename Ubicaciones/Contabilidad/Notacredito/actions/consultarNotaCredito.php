...
$query_consultaFactura = "SELECT * FROM conta_t_notacredito_cfdi where fk_id_cuenta_captura_nc = ? ";
...
if( $total_consultaFactura > 0 ) {
	...
	$pk_id_factura = $row_consultaFactura['pk_id_notacredito'];
	...
	$n_cantidadNC = $row_consultaFactura['n_cantidadNC'];
	$fk_cveUnidadNC = $row_consultaFactura['fk_cveUnidadNC'];
	$fk_c_ClaveProdServ = $row_consultaFactura['fk_c_ClaveProdServ'];
	$s_descripNC = $row_consultaFactura['s_descripNC'];
	$n_valorUnitNC = $row_consultaFactura['n_valorUnitNC'];
}
