...
//DATOS GENERALES DEL EMBARQUE ******************************************
    ...
    $query_DGE="UPDATE conta_t_notacredito_captura_det SET s_conceptoEsp = ?, s_descripcion = ?
                      WHERE pk_id_partida = ?";
...
if( $Total_POCME > 0 ){
    ...
    foreach ($pocmes as $pocme) {
      ...
      if( $POCME_idpartida > 0 ){
        $query_POCME="UPDATE conta_t_notacredito_captura_det SET
                                                              n_cantidad = ?,
                                                              fk_id_cuenta = ?,
                                                              s_conceptoEsp = ?,
                                                              s_conceptoEnglish = ?,
        ...
        $query_POCME="INSERT INTO conta_t_notacredito_captura_det(fk_id_cuenta_captura,s_tipoDetalle,n_cantidad,fk_id_cuenta,s_conceptoEsp,s_conceptoEnglish,s_descripcion,n_importe,n_total,fk_id_concepto)
                            VALUES (?,?,?,?,?,?,?,?,?,?)";
    ...
    $query_POCMEdelete="DELETE FROM conta_t_notacredito_captura_det WHERE pk_id_partida = ?";
...
if( $Total_Pagos <> 0 ){
    ...
    foreach ($cargos as $cargo) {
      ...
      if( $cargo_idpartida > 0 ){
        $query_cargos="UPDATE conta_t_notacredito_captura_det SET
                                                              fk_id_concepto = ?,
                                                              fk_id_cuenta = ?,
                                                              s_conceptoEsp = ?,
                                                              n_total = ?
        ...
        $query_cargos="INSERT INTO conta_t_notacredito_captura_det(fk_id_cuenta_captura,s_tipoDetalle,fk_id_concepto,fk_id_cuenta,s_conceptoEsp,n_total)
                                                        VALUES (?,?,?,?,?,?) ";
    ...
    $query_cargodelete="DELETE FROM conta_t_notacredito_captura_det WHERE pk_id_partida = ?";
  ...
  foreach ($honorarios as $hon) {
      ...
      if( $hon_idpartida > 0 ){
        if( $hon_idTipoCta == '0400-00001' ){
          $query_hon="UPDATE conta_t_notacredito_captura_det SET s_conceptoEsp = ?,
                                                              fk_id_cuenta = ?,
                                                              fk_c_ClaveProdServ = ?,
                                                              n_importe = ?,
                                                              n_IVA = ?,
        ...
        $query_hon="INSERT INTO conta_t_notacredito_captura_det( fk_id_cuenta_captura,
                                                                  s_tipoDetalle,
                                                                  n_cantidad,
                                                                  fk_c_claveUnidad,
                                                                  s_Unidad,
    ...
    $query_hondelete="DELETE FROM conta_t_notacredito_captura_det WHERE pk_id_partida = ?";
...
//DEPOSITOS *******************************************************
    if( $Total_Anticipos > 0 ){
        ...
        $query_depositos="INSERT INTO conta_t_notacredito_captura_det(fk_id_cuenta_captura,s_tipoDetalle,n_noDeposito,n_total)
                                                            VALUES (?,?,?,?) ";
    ...
    $query_depositosdelete="DELETE FROM conta_t_notacredito_captura_det WHERE pk_id_partida = ?";
