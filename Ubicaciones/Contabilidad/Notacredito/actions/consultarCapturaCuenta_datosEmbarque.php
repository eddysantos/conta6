...
$query_consultaEmbarque = "SELECT pk_id_partida,s_conceptoEsp,s_descripcion FROM conta_t_notacredito_captura_det WHERE fk_id_cuenta_captura_nc = ? and s_tipoDetalle = 'DatGnEmbarq' ";
