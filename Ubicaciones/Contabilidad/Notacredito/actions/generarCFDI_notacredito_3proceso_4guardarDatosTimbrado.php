...
$queryNCcfdi = "UPDATE conta_t_notacredito_cfdi
                SET s_UUID = ?, fk_id_certificado = ?, s_id_certificadoSAT = ?, s_selloCFDI = ?,
                    ...
                    s_descripNC = ?, n_valorUnitNC = ?, n_importeNC = ?,
...
$stmtNCcfdi->bind_param('ssssssssssssss',$UUID,$noCertificado,$certSAT,$selloCFDI,$SelloSAT,$versionTimbre,$fechaTimbre,$usuario,$poliza,$s_conceptoEsp,$n_importe,$n_importe,$cuenta,$id_factura);
if (!($stmtNCcfdi)) {
  $system_callback['code'] = "500";
