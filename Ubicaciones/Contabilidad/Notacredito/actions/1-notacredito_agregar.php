...
$T_idFactura = $_POST['T_idFactura'];
$T_UUIDFactura = $_POST['T_UUIDFactura'];
$T_totalFactura = $_POST['T_totalFactura'];
...
//   $db->beginTransaction();
    ...
    //DATOS PRINCIPALES
    $query_mst="INSERT INTO conta_t_notacredito_captura( fk_usuario,
                                                      fk_referencia,
                                                      fk_id_aduana,
                                                      fk_id_almacen,
                                                      fk_id_cliente,
    ...
    $stmt_mst->bind_param('ssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss',
                          $Usuario_Cta,
                          $ID_Referencia,
                          $ID_Aduana,
                          $ID_Almacen,
    ...
    require $root . '/conta6/Ubicaciones/Contabilidad/Notacredito/actions/1-notacredito_agregar_detalle.php';
