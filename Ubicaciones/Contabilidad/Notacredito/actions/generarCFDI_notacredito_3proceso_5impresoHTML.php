...
class MYPDF extends TCPDF {
  public function Header() {
    ...
    $this->Cell(0, 12, 'NOTA DE CRÉDITO', 0, 1, 'C', 0, '', 0, false, 'T', 'C');
  }
      ...
      <table class="border">
        <thead>
          <tr bgcolor="#e00000" color="rgb(255, 255, 255)" align="center">
            <td width="25%"><b>NOTA DE CRÉDITO</b></td>
            <td width="40%"><b>NO.CERTIFICADO</b></td>
            <td width="35%"><b>LUGAR Y FECHA</b></td>
          </tr>
        </thead>
        <tbody>
          <tr align="center">
            <td width="25%"><b>'.$pk_id_factura.'</b></td>
            <td width="40%">'.$fk_id_certificado.'</td>
            <td width="35%"><font>'.$s_lugarExpedicion_txt.'</font><br/>'.$d_fechaTimbrado.' </td>
          </tr>
          <tr bgcolor="#e00000" color="rgb(255, 255, 255)" align="center">
            <td width="20%"><b>FACTURA</b></td>
            <td width="80%"><b>CFDI RELACIONADO</b></td>
          </tr>
          <tr aling="center">
            <td width="20%">'.$id_facturaRelacionada.'</td>
            <td width="80%">'.$s_UUID_factura.'</td>
          </tr>
        </tbody>
      </table>
    </td>
...
<table class="border">
  <thead>
    <tr bgcolor="#e00000" color="rgb(255, 255, 255)" align="center">
      ...
      <td width="45%" align="left"><b>DESCRIPCIÓN</b></td>
      <td width="20%" align="right"><b>V.UNIT.</b></td>
    </tr>
  </thead>
  <tbody>
    <tr align="center">
      <td width="10%">'.$n_cantidadNC.'</td>
      <td width="15%">'.$fk_cveUnidadNC.'</td>
      <td width="10%">'.$fk_c_ClaveProdServ.'</td>
      <td width="45%" align="left">'.$s_descripNC.'</td>
      <td width="20%" align="right">'.$n_valorUnitNC.'</td>
    </tr>
  </tbody>
</table>';
...
<table>
  <tr>
    ...
    <td width="70%"><table>
        ...
        <tr>
    			<td width="70%" align="right">Total Nota de Crédito :</td>
...
$pdf->writeHTML($InfoNotaCredito, true, false, true, false, 'C');
...
//$pdf->Output("prueba2", 'I');

$pdf->Output($rutaRepFilePDF, 'F');
chmod($rutaRepFilePDF,0775);
