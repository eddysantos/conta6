    ...
    <div class='text-center'>
      ...
      <div class="contorno" style="<?php echo $marginbottom ?>">
        <table class="table w-100">
          <tr>
            <td class="w-50">
              <table class="table">
                <tr class="row">
                  <td class="col-md-3"><input type="text" class="efecto" id="tipoRelacion" value='04' readOnly /></td>
                  <td class="col-md-3"><input type="text" class="efecto" id="folioRelacionado" value='<?PHP echo $pk_id_factura;?>' readOnly/></td>
                  <td class="col-md-4"><input type="text" class="efecto" id="UUIDrelacionado" siza='40' value='<?php echo $s_UUID;?>' readOnly/></td>
                </tr>
                <tr class="row">
                  <td class="col-md-3">
                ...
                <td class="col-md-3 text-left pt-4"></td>
        ...
        <div class="row justify-content-center">
          <div class="col-md-3">
            <input class="efecto boton validarstring" type='button' value="GUARDAR" onclick="validarStringSAT(this);quitarNoUsar(this);" id="sustituir-cta-cfdi" tabindex="<?php echo $tabindex = $tabindex+1; ?>">
          </div>
          <!-- <div id="mensaje"></div> -->
        </div>
      </div>
