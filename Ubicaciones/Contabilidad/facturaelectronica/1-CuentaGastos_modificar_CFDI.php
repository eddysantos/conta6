    ...
    <div class='text-center'>
                  ...
                  <form onsubmit="return false">
                    <table class='table'>
                      ...
                      <tbody id="tbodyHonorarios">
                        <?php echo $datosHonorariosModifi_CFDI; ?>
                      </tbody>
                    </table>
                  </form>
              </div>
      ...
      <div class="contorno" style="<?php echo $marginbottom ?>">
        ...
        <div class="row justify-content-center">
          <div class="col-md-3">
            <input class="efecto boton validarstring" type='button' value="MODIFICAR" onclick="validarStringSAT(this);quitarNoUsar(this);" id="modificar-cta-cfdi" tabindex="<?php echo $tabindex = $tabindex+1; ?>">
          </div>
          <!-- <div id="mensaje"></div> -->
        </div>
      </div>
