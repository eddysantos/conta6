...
if($referencia != "SN"){
    ...
    if( $aduana == 240 && $oRst_permisos["s_cta_gastos_POCME_automatico"] == 1 ){
      require $root . '/Resources/PHP/actions/tarifas_consultaPOCME_cliente_cobroAutomatico.php';  #$POCME_automatico
    }
    ...
    #require $root . '/Resources/PHP/DatabasesRemote/traficoSAIWEB_pedimento.php';
    require $root . '/Resources/PHP/actions/consultaDatosReferenciaPedimento.php'; #$impuesto_CEXT
    require $root . '/Resources/PHP/actions/consulta_impuestos_comercioExterior.php'; #$impuesto_CEXT
    		...
    		<!--div id='collapseTwo'-->
              <form class='form1' onsubmit="return false">
                <div>
                  ...
                  <div class='row mt-3 aling-items-center'>
                ...
                <table class='table'>
                  ...
                  <tbody id="tbodyCargos">
                    ...
                    <tr id="10" class="row m-0 align-items-center">
                ...
                <form class='form1'>
                  <div class="">
                    ...
                    <div class='row m-0 mt-3 mb-3 justify-content-center align-items-center'>
                      ...
                      <div class='col-md-2 p-0 aling-self-center'>
