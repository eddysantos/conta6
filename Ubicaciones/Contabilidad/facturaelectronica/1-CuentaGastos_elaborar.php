...
<input type="text" id="T_No_calculoTarifa" value="<?php echo $calculoTarifa;?>">
...
<table border="0" width="100%" style="font-family: Trebuchet MS; font-size:10pt; border: 1px solid #000000;" cellspacing="0">
		...
		<tr id="24" onmouseover="cambiar_color_over(this)" onmouseout="cambiar_color_out(this)">
			<td colspan="4"><input type="text" id="T_Honorarios_6" size="60" maxlength="60" onchange="javascript:eliminaBlancoIni(this.form.T_Honorarios_6);eliminaBlancoFin(this.form.T_Honorarios_6);eliminaBlancosIntermedios(this.form.T_Honorarios_6);validarStringSAT(this.form.T_Honorarios_6);" class="T_Honorarios" readonly style="border:1px solid #C0C0C0; font-family: Trebuchet MS; font-size:10pt;" tabindex="95"></td>
			<td><a href="javascript:limpiarCampos('H6')"><img class='icochico' src='/conta6/Resources/iconos/002-trash.svg'></a></td>
			<td align="center"><input type="text" id="T_Hcta6" class="T_Honorarios_idcta" size="15" style="border:1px solid #C0C0C0; font-family: Trebuchet MS; font-size:10pt; text-align:right; background-color:#DCDCDC" value="" readonly /></td>
			<td align="center"><input type="text" id="T_Hps6" class="T_Honorarios_idps" size="15" style="border:1px solid #C0C0C0; font-family: Trebuchet MS; font-size:10pt; text-align:right; background-color:#DCDCDC" value="" readonly /></td>
			<td align="center"><input type="text" id"T_Honorarios_61" size="18" onblur="validaIntDec(this);validaDescImporte(this.form.T_Honorarios_6,this.form.T_Honorarios_61);cortarDecimalesObj(this.form.T_Honorarios_61,2);Iva_Importe_Hon6();" class="T_Honorarios_Importe" style="border:1px solid #C0C0C0; font-family: Trebuchet MS; font-size:10pt; text-align:right;" value="0" tabindex="<?php echo $tabindex = $tabindex+1; ?>"></td>
			<td align="center"><input type="text" id"T_Honorarios_62" size="20" class="T_Honorarios_IVA" style="border:1px solid #C0C0C0; font-family: Trebuchet MS; font-size:10pt; text-align:right; background-color:#DCDCDC" value="0"  readonly></td>
			<td align="center"><input type="text" id"T_Honorarios_64" size="20" class="T_Honorarios_RET" style="border:1px solid #C0C0C0; font-family: Trebuchet MS; font-size:10pt; text-align:right; background-color:#DCDCDC" value="0"  readonly></td>
			<td align="center"><input type="text" id"T_Honorarios_63" size="20" class="T_Honorarios_Subtotal" style="border:1px solid #C0C0C0; font-family: Trebuchet MS; font-size:10pt; text-align:right; background-color:#DCDCDC" value="0" readonly></td>
		</tr>
		<tr id="25" onmouseover="cambiar_color_over(this)" onmouseout="cambiar_color_out(this)">
			<td width="20%" colspan="4"><input type="text" id="T_Honorarios_7" size="60" maxlength="60" onchange="javascript:eliminaBlancoIni(this.form.T_Honorarios_7);eliminaBlancoFin(this.form.T_Honorarios_7);eliminaBlancosIntermedios(this.form.T_Honorarios_7);validarStringSAT(this.form.T_Honorarios_7);" class="T_Honorarios" readonly style="border:1px solid #C0C0C0; font-family: Trebuchet MS; font-size:10pt;" tabindex="99"></td>
			<td width="20%"><a href="javascript:limpiarCampos('H7')"><img class='icochico' src='/conta6/Resources/iconos/002-trash.svg'></a></td>
			<td align="center"><input type="text" id="T_Hcta7" class="T_Honorarios_idcta" size="15" style="border:1px solid #C0C0C0; font-family: Trebuchet MS; font-size:10pt; text-align:right; background-color:#DCDCDC" value="" readonly /></td>
			<td align="center"><input type="text" id"T_Hps7" class="T_Honorarios_idps" size="15" style="border:1px solid #C0C0C0; font-family: Trebuchet MS; font-size:10pt; text-align:right; background-color:#DCDCDC" value="" readonly /></td>
			<td width="15%" align="center"><input type="text" id"T_Honorarios_71" size="18" onblur="validaIntDec(this);validaDescImporte(this.form.T_Honorarios_7,this.form.T_Honorarios_71);cortarDecimalesObj(this.form.T_Honorarios_71,2);Iva_Importe_Hon7();" class="T_Honorarios_Importe" style="border:1px solid #C0C0C0; font-family: Trebuchet MS; font-size:10pt; text-align:right;" value="0" tabindex="<?php echo $tabindex = $tabindex+1; ?>"></td>
			<td width="7%" align="center"><input type="text" id"T_Honorarios_72" size="20" class="T_Honorarios_IVA" style="border:1px solid #C0C0C0; font-family: Trebuchet MS; font-size:10pt; text-align:right; background-color:#DCDCDC" value="0"  readonly></td>
			<td width="8%" align="center"><input type="text" id"T_Honorarios_74" size="20" class="T_Honorarios_RET" style="border:1px solid #C0C0C0; font-family: Trebuchet MS; font-size:10pt; text-align:right; background-color:#DCDCDC" value="0"  readonly></td>
			<td width="15%" align="center"><input type="text" id"T_Honorarios_73" size="20" class="T_Honorarios_Subtotal" style="border:1px solid #C0C0C0; font-family: Trebuchet MS; font-size:10pt; text-align:right; background-color:#DCDCDC" value="0" readonly></td>
		</tr>
