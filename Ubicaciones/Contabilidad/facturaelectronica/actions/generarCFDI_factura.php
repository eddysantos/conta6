...
if( $total_datosCert > 0 ){
  ...
  if( $rows_ctasCliente > 0 ){
    ...
    if( $total_consultaDatosCtaGastos == 0 ){
      ...
      // echo "\n";
      $system_callback['code'] = 1;
      $system_callback['message'] .= "Folio Cuenta Gastos: ".$folioCtaGastos."\n";
    }else{
    ...
    if( $total_consultaDatosCFDI == 0 ){
      require $root . '/conta6/Ubicaciones/Contabilidad/facturaelectronica/actions/generarCFDI_factura_2genFactura.php'; #$folioCtaGastos
      // echo "se genero factura: ".$folioFactura;
      // echo "<br>";
      //echo "generar factura y timbrar";
      $system_callback['code'] = 1;
      $system_callback['message'] .= "Folio Factura: ".$folioFactura."\n";
