...
if( $oRst_permisos['s_facturas_timbrar'] == 1 ){
  ...
  if( $total_datosCert > 0 ){
    ...
    if( $rows_ctasCliente > 0 ){
      ...
      require $root . '/Ubicaciones/Contabilidad/actions/consultaDatosCFDI_factura_ctaGastos.php';
      ...
      require $root . '/Ubicaciones/Contabilidad/actions/consultaDatosCFDI_factura.php';
      if( $total_consultaDatosCFDI == 0 ){
        require $root . '/Ubicaciones/Contabilidad/facturaelectronica/actions/generarCFDI_factura_2genFactura.php'; #$folioFactura
        ...
        require $root . '/Ubicaciones/Contabilidad/facturaelectronica/actions/generarCFDI_factura_3proceso.php';
        $system_callback['code'] = 1;
