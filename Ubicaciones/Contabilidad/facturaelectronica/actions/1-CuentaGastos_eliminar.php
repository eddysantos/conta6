...
$query_CG_mst = "DELETE FROM conta_t_facturas_captura WHERE pk_id_cuenta_captura = ?";
...
$query_CG_det = "DELETE FROM conta_t_facturas_captura_det WHERE fk_id_cuenta_captura = ?";
