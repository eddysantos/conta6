...
while( $row_ctaGastos = $rslt_ctaGastos->fetch_assoc() ){
	...
	if( $oRst_permisos['s_cta_gastos_modificar'] == 1 && $row_ctaGastos['fk_id_aduana'] == $aduana &&
	...
	if( $oRst_permisos['s_cta_gastos_consultar'] == 1 ){
		$hrefconsultar = "<a href='#' onclick='ctaGastosCapturaConsultar($id_captura,&#39;consulta&#39;)'><img class='icomediano ml-2' src='/Resources/iconos/magnifier.svg'></a>
									<a href='#' onclick='ctaGastosCapturaImprimir($id_captura)'><img class='icomediano ml-2' src='/Resources/iconos/printer.svg'></a>";
	}
	if( $oRst_permisos['s_cta_gastos_cancelar'] == 1 && $row_ctaGastos['fk_id_aduana'] == $aduana &&
		$id_factura == 0 && $id_poliza == 0 && $s_cancela_factura == 0 ){
		$hrefcancelar = "<a href='#' onclick='ctaGastosCapturaEliminar($id_captura)'><img class='icomediano' src='/Resources/iconos/002-trash.svg'></a>";
	}
