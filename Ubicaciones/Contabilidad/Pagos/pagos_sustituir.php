...
<div class="text-center">
    ...
    <table class='table mt-5' id='eInfo'>
      ...
      <tbody class='font14 text-center'>
        <tr class="row">
          ...
          <td class="p-1 col-md-2"><input class="efecto text-left h22 border-0" type="text" id="id_pago_captura"></td>
          <td class="p-1 col-md-3"></td>
          <td class="p-1 col-md-3">
            <input class="h22 bt border-0 text-center" type="text" id="T_Usuario" size="20" readonly>
          </td>
          <td class="p-1 col-md-3">
            <input class="h22 bt border-0 text-center" type="text" id="T_Fecha_Cta" size="20" readonly>
          </td>
        </tr>
  ...
  <div id='folioSustituir' class='contorno' style='display:none'>
    ...
    <table class='table'>
      ...
      <tbody class='font14 text-center'>
        <tr class="row">
          <td class="p-1 col-md-4"><input class="h22 bt border-0 efecto" type="text" id="idPago_sust" size="20" value="<?php echo $pk_id_pago; ?>" readonly></td>
          <td class="p-1 col-md-4"><input class="h22 bt border-0 efecto" type="text" id="uuid_sust" size="20" value="<?php echo $s_UUID; ?>" readonly></td>
          <td class="p-1 col-md-4"><input class="h22 bt border-0 efecto" type="text" id="tipoRel_sust" size="20" value="04" readonly></td>
        </tr>
      </tbody>
    </table>
  </div>
  ...
  <div class="row justify-content-center m-0" style="<?php echo $marginbottom ?>">
    <div class="col-md-3">
      <!--input class="efecto boton" type='button' value="GUARDAR" id="sustituir-pago" /-->
