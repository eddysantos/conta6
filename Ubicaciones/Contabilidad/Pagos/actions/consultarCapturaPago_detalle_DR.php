...
$query_consultaDetalle_DR = "SELECT * FROM conta_t_pagos_captura_det_dr where fk_id_pago_captura = ?  ORDER BY pk_id_DR ";
...
$stmt_consultaDetalle_DR->bind_param('s',$cuenta);
if (!($stmt_consultaDetalle_DR)) {
	$system_callback['code'] = "500";
