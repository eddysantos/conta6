    ...
    <br />
      <table class="border">
        ...
        <tbody>
          ...
          <tr><td width="100%">'.$s_ciudad.', '.$s_estado.' ' . $s_codigo.'</td></tr>
...
<div border="1">
      <table>
        <tr>
          <td width="10%"><b>Moneda</b></td>
					<td width="20%"><b>Uso de CFDI</b></td>
					<td width="70%"><b>Régimen Fiscal</b></td>
        </tr>
        <tr>
          <td>'.$fk_id_monedaPago.'</td>
          <td>'.$txt_UsoCFDI.'</td>
					<td>'.$regimen.'</td>
        </tr>
      </table>
...
$pdf->writeHTML($usoCFDI, true, false, true, false, '');
