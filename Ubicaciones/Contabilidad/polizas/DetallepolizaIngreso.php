...
<div class="container-fluid text-center">
  <div class="row submenuMed p-0 pt-3">
  ...
  <nav class="mt-5 mb-4">
    <ul class="nav nav-pills nav-fill mb-3">
      ...
      <li class="nav-item">
        <a class="nav-link pills">Detalle de Póliza</a>
      </li>
      <li class="nav-item">
      ...
      <div id="two"><!--DETALLE DE POLIZAS-->
        ...
        <div class="row">
          <div class="col-md-2 text-left">
            <a href="" class="boton border-0 ml-5"><img class="icomediano" src= "/conta6/Resources/iconos/printer.svg"></a>
          </div>
