              ...
              <tbody>
                <tr class="row m-0 mt-5">
                  <td class="col-md-10">
                    ...
                    echo '<input class="efecto tiene-contenido popup-input" id="fk_id_cuenta" type="text" id-display="#popup-display-cuentas_mst_2niv" action="cuentas_mst_2niv" db-id="" autocomplete="new-password" onchange="Actualiza_Cuenta()">';
                    }else{
                      if( $tipo == 2){
                        echo '<input class="efecto tiene-contenido popup-input" id="detpol-cuenta" type="text" id-display="#popup-display-cuentas_mst_2niv" action="cuentas_mst_2niv_limitada_paraTipo2" db-id="" autocomplete="new-password" onchange="Actualiza_Cuenta()">';
                      }else{
                        echo '<input class="efecto tiene-contenido popup-input" id="detpol-cuenta" type="text" id-display="#popup-display-cuentas_mst_2niv" action="cuentas_mst_2niv_limitada" db-id="" autocomplete="new-password" onchange="Actualiza_Cuenta()">';
                      }
                    }?>
