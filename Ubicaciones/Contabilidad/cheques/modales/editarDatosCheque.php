            ...
            <table class="table form1 font14">
              <tbody>
                <td class="col-md-3 input-effect">
                    <input class="efecto tiene-contenido popup-input" id="chCta" type="text" id-display="#popup-display-chCta" action="cuentas_mst_0100_oficina" autocomplete="new-password"
