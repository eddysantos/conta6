    ...
    <table class="table text-center">
      ...
      <tbody class="">
        <tr class="row m-0">
          ...
          <td class="col-md-1">
            <input class="efecto text-center" type="text"  value="3345">
          </td>
          <td class="col-md-2">
            <input class="efecto text-center data-date" type="date">
          </td>
          <td class="col-md-1">
            <input class="efecto text-center" type="text" value="$123,456">
          </td>
          <td class="col-md-2">
        ...
        <tr class="row m-0">
          <td class="col-md-1 brx2">
            <input id="ch-cuenta" class="text-normal efecto text-center tiene-contenido" value="0100-00006" type="text">
            <label for="ch-cuenta">CUENTA</label>
          </td>

          <td class="col-md-6 input-effect brx2">
            <input  list="ch-benef" class="text-normal efecto text-center"  id="ch-beneficiario">
        ...
        <tr class="row m-0">
          <td class="col-md-1 iap brx1 pt-10" style="font-size:16px!important;">111</td>
          <td class="col-md-3 iap brx1 pt-10" style="font-size:16px!important;">RAER8708025X3</td>
          <td class="col-md-7 iap brx1">
            <input id="concep" class="inp-nom noborder" value=" ROSENDO ISAAC RANGEL ESTRADA" type="text">
          </td>
          ...
          <table class="table">
            <thead style="font-size: 18px;font-weight: 100;">
              <tr class="row m-0 tRepo2">
                <td class="col-md-12 text-center">CAPTURA DETALLE DE CHEQUE</td>
              </tr>
            </thead>
            <tbody class="cuerpo">
              <tr class="row m-0">
          ...
          <table class="table table-hover text-center">
            <thead style="font-size: 18px;font-weight: 100;">
              <tr class="row tRepo2 m-0">
                <td class="col-md-12 text-center">DETALLE CHEQUE</td>
              </tr>
            </thead>
            <tbody class="">
              <tr class="row m-0">
