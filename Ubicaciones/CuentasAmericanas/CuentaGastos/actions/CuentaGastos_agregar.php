...
//   $db->beginTransaction();
    ...
    //DATOS PRINCIPALES
    $query_mst="INSERT INTO contame_t_facturas(
                                              fk_referencia,
                                              s_imp_exp,
                                              d_fecha,
                                              s_guia_master,
    ...
    $stmt_mst->bind_param('sssssssssssssssssssssssssssssssssssss',
                                $ID_Referencia,
                                $Tipo,
                                $T_Date,
                                $T_Freight,
    ...
    #************ historial ************
    $descripcion = "Se genero cuenta: $nfolio ";
  ...
  //$db->commit();
    //$system_callback['hon'] = $vencimiento;
