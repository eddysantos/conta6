...
<div class='container-fluid'>
  ...
  <div id='contornodCliente' class='contorno' style='display:none'>
    ...
    <table class='table text-center' id='dCliente'>
      <thead>
  ...
  <div id='contornodEmbarque' class='contorno' style='display:none'>
    ...
    <table class='table text-center mt-4' id='dEmbarque'>
      <thead>
        <tr class='row encabezado font16'>
  ...
  <div id='contornodUsuario' class='contorno' style='display:none'>
    ...
    <table  class='table text-center mt-3' id='dUsuario'>
      <thead>
  ...
  <div class='contorno'>
    ...
    <div class='container-fluid'>
      <table class='table text-center font14 mt-4'>
        <thead>
