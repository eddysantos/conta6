...
//DATOS DEL EMBARQUE ***********************************************************
$seccion = 'DatGnEmbarq';
$query_DatGnEmbarq="INSERT INTO conta_t_proforma_det(fk_id_proforma,s_tipoDetalle,s_conceptoEsp,s_descripcion)
...
if( $Total_Pagos <> 0 ){
    ...
    $query_cargos1="INSERT INTO conta_t_proforma_det(fk_id_proforma,s_tipoDetalle,fk_id_cuenta,s_conceptoEsp,n_total)
                                                    VALUES (?,?,?,?,?) ";
...
if( $Total_Gral_Importe > 0 ){
  ...
  $query_hon1="INSERT INTO conta_t_proforma_det( fk_id_proforma,
                                                          s_tipoDetalle,
                                                          n_cantidad,
                                                          fk_c_claveUnidad,
                                                          s_Unidad,
...
if( $Total_Anticipos > 0 ){
    ...
    $query_depositos="INSERT INTO conta_t_proforma_det(fk_id_proforma,s_tipoDetalle,n_noDeposito,n_total)
                                                        VALUES (?,?,?,?) ";
