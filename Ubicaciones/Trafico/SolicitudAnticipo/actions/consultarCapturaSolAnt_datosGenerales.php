...
$query_consultaGenerales = "SELECT * FROM conta_t_proforma where pk_id_proforma = ? ";
...
if( $total_consultaGenerales > 0 ) {
	...
	$pk_id_cuenta_captura = $row_consultaGenerales['pk_id_proforma'];
	$d_fecha_proforma = date_format(date_create($row_consultaGenerales['d_fecha_proforma']),"d-m-Y"); 
