...
$query_CG_mst = "DELETE FROM conta_t_proforma WHERE pk_id_proforma = ?";
...
$query_CG_det = "DELETE FROM conta_t_proforma_det WHERE fk_id_proforma = ?";
...
$descripcion = "Se elimino la proforma: $partida ";
